...
class Transfer2Vek2(TemplateFunction):
    '''
    Kopiert die ÖREBK-Transferstruktur (OEREB2) nach Vek2. Es werden nur diejenigen Teile der
    ...
    def __execute(self):
        ...
        target_connection = self.general_config['connection_files']['VEK2_OEREB2_ORA']
        ...
        if liefereinheiten == '()':
            ...
            for oereb_table in oereb_tables:
                ...
                self.general_config['connections']['VEK2_OEREB2_ORA'].db_write(oereb_delete_sql)
                
                username = self.general_config['connections']['VEK2_OEREB2_ORA'].username
                ...
                target_layer = oereb_tablename + "_target_layer_vek2_2"
