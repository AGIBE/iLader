...
class KopieVek3Ersatz(TemplateFunction):
    ...
    In der Zielinstanz VEK3 sind die Ebenen bereits vorhanden. Sie werden vorgängig
    geleert und neu gefüllt (Truncate und Append). Sie dürfen nicht gelöscht werden!
    Es müssen daher auch keine Berechtigungen gesetzt werden.
