...
class Transfer2Vek1_PG(TemplateFunction):
    '''
    ...
    def __execute(self):
        ...
        '''
        self.logger.info("ÖREBK-Transferstruktur (OEREB2) wird nach vek1 (PostgreSQL) kopiert.")
        ...
        if liefereinheiten == '':
            ...
            self.logger.info("Die ÖREBK-Transferstruktur (OEREB2) wurde nach vek1 (PostgreSQL) kopiert.")       
            self.finish()